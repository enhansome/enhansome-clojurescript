...
* [Datascript](https://github.com/tonsky/datascript) ⭐ 5,781 | 🐛 79 | 🌐 Clojure | 📅 2025-10-11 – An immutable in-memory database and Datalog query engine in ClojureScript.
* [Konserve](https://github.com/replikativ/konserve) ⭐ 317 | 🐛 20 | 🌐 Clojure | 📅 2026-08-12 – A clojuresque key-value/document store protocol with core.async.
